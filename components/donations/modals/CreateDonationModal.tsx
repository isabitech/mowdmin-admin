...
export default function CreateDonationModal({
  ...
  return (
    <div className="fixed inset-0 bg-gray-900/60 overflow-y-auto h-full w-full z-[150] flex items-center justify-center p-4 min-h-screen">
      <div className="fixed inset-0 transition-opacity" onClick={handleClose}></div>
      <div className="relative bg-white w-full max-w-4xl max-h-[90vh] flex flex-col shadow-2xl rounded-3xl overflow-hidden animate-in zoom-in-95 fade-in duration-300">
        <div className="shrink-0 px-8 py-5 border-b border-gray-100 flex items-center justify-between bg-gradient-to-r from-white to-gray-50">
          ...
          <button
            ...
            onClick={handleClose}
            disabled={isLoading}
            className="text-gray-400 hover:text-gray-900 transition-colors p-2 hover:bg-gray-100 rounded-full disabled:opacity-50"
          >
        ...
        <form onSubmit={handleSubmit} className="overflow-y-auto flex-1 p-8 space-y-6 flex flex-col">
