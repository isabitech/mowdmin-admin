...
import { CreateGroupData, GroupType, GroupStatus, MeetingFrequency, MeetingDay } from '@/constant/groupTypes';
...
export default function CreateGroupModal({ isOpen, onClose, onSuccess, isSubmitting }: CreateGroupModalProps) {
